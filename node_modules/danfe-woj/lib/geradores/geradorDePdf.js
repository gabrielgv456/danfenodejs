    ...
    function desenharPagina() {
        ...
        if (temLogotipo) {
            ...
            function base64ToBuffer(base64) {
                const base64Data = base64.replace(/^data:image\/\w+;base64,/, ""); // Remove prefixo, se houver
                return Buffer.from(base64Data, 'base64');
            }
            const doc = new Pdf();
            const imageBuffer = base64ToBuffer(emitente.getLogotipo());

            doc.pipe(fs.createWriteStream('output.pdf'));

            pdf.image(imageBuffer, 92.34, 92.34 + ajusteCabecalho + args.ajusteYDoLogotipo, {
                fit: [60, 60]
            });
        }
        ...
        if (page === 0) {
            ...
            pdf.image(args.pathCredits, 506, 815, {
                fit: [60, 60]
            });
