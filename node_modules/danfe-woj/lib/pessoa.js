...
let Pessoa = (function () {
    ...
    Pessoa.prototype.getRegistroNacionalFormatado = function () {
        if (!this.getRegistroNacional()) {
            return ''
        }
        if (this.getRegistroNacional().length === 11) {
            return this.getRegistroNacional().slice(0, 3) + '.' + this.getRegistroNacional().slice(3, 6) + '.' + this.getRegistroNacional().slice(6, 9) + '-' + this.getRegistroNacional().slice(9, 11);
        } else {
