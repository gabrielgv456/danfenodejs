...
let Volumes = (function() {
    ...
    Volumes.prototype.getQuantidadeFormatada = function() {
        return new Intl.NumberFormat('pt-BR').format(this.getQuantidade());
    };
    ...
    Volumes.prototype.getPesoLiquidoFormatado = function() {
        return new Intl.NumberFormat('pt-BR', { minimumFractionDigits: 3, maximumFractionDigits: 3 }).format(this.getPesoLiquido());
    };

    Volumes.prototype.getPesoBrutoFormatado = function() {
        return new Intl.NumberFormat('pt-BR', { minimumFractionDigits: 3, maximumFractionDigits: 3 }).format(this.getPesoBruto());
    };
